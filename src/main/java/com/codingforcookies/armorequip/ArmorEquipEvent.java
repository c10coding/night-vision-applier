...
public final class ArmorEquipEvent extends PlayerEvent implements Cancellable{
	...
	private final com.codingforcookies.armorequip.ArmorType type;
	 ...
	 */
	public ArmorEquipEvent(final Player player, final EquipMethod equipType, final com.codingforcookies.armorequip.ArmorType type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece){
		super(player);
	...
	public final com.codingforcookies.armorequip.ArmorType getType(){
		return type;
	}
